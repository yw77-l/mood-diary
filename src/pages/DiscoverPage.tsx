import { Newspaper, Languages, Wrench } from 'lucide-react';
...
export default function DiscoverPage() {
  return (
    <div className="animate-[fadeIn_0.4s_ease]">
      ...
      <p className="text-xs text-text-sub text-center mb-5">更多好玩的功能即将上线~</p>

      <div className="flex flex-col gap-4">
        {cards.map(({ key, icon: Icon, title, emoji, desc, color, iconColor }) => (
          <div
            key={key}
            className={`relative bg-gradient-to-br ${color} rounded-[32px] p-6 shadow-[0_8px_30px_rgb(255,182,193,0.1)]`}
          >
